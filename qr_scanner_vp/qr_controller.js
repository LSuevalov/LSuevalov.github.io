...
const tableUrl = "https://script.google.com/macros/s/AKfycbzrCMW-satHcWZmD_Nx-qe-M1KdN4Ci3-3mu_yt8z3RSyFtfacZOyFVAR6iQpT91Ry_xA/exec";
...
let video, confirmationZone, scanResultText, vpInput, sendResultsButton, cancelResultsButton, requestResultDisplay;
...
function sendScanResults() {
    let params = `?code=${code}&sector=${sectorNumber}&textinput=${vpInput.val()}`;
